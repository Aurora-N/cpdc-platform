<template>
  <div class="min-h-screen bg-cover bg-center flex items-center justify-center px-4 py-12 relative overflow-hidden" style="background-image: url('/introbg.png')">
    ...
    <div class="profile-card w-full max-w-2xl relative z-10 animate-fade-in">
      <!-- 顶部装饰 -->
      <div class="text-center mb-10">
        <div class="inline-block mb-4">
          <div class="w-24 h-24 mx-auto bg-white/20 rounded-full flex items-center justify-center backdrop-blur-sm border-2 border-white/40 shadow-lg">
        ...
        <h1 class="text-4xl font-bold text-white mb-3 tracking-wide">个人中心</h1>
        <p class="text-white/80 text-lg">管理您的账户信息</p>
